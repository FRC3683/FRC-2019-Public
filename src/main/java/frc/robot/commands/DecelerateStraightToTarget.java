...
public class DecelerateStraightToTarget extends DriveStraightToTarget {
  ...
  public DecelerateStraightToTarget(double distance, double angle, double startingPower, double endingPower, double decelerationToTopSpeedRatio) {
  ...
  public DecelerateStraightToTarget(double distance, double angle, double startingPower, double endingPower) {
    this(distance, angle, startingPower, endingPower, 1.0);
  }

  public DecelerateStraightToTarget(double distance, double angle, double endingPower) {
    //TODO: determine minimum power
    this(distance, angle, 0.0, endingPower, 1.0);
  }
  
  public DecelerateStraightToTarget(double distance, double angle) {
    //TODO: determine minimum power
  ...
  protected void execute() {
    ...
    double alpha = MathUtils.clamp01((Robot.m_driveTrain.getDistance() - zeroDist)/decel_dist);
